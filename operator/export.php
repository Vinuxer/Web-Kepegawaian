...
// Set properties
$objPHPExcel->getProperties()->setCreator("BBPPK - Lembang Jawa Barat")
							 ->setLastModifiedBy("BBPPK - Lembang Jawa Barat")
							 ->setTitle("Export data pegawai")
							 ->setSubject("aplikasi data kepegawaian BBPPK  jabar")
							 ->setDescription("Export data kepegawaian dari database.")
							 ->setKeywords("BBPPK - Lembang Jawa Barat jabar kepegawaian")
