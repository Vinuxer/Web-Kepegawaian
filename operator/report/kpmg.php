...
$judul.="DILINGKUNGAN BBPPK LEMBANG \nPERIODE ".date('F')." ".date('Y');

PHPExcel_Cell::setValueBinder( new PHPExcel_Cell_AdvancedValueBinder() );
$objPHPExcel = new PHPExcel();

// Set properties
$objPHPExcel->getProperties()->setCreator("BBPPK LEMBANG http://wajatmaka.web.id")
							 ->setLastModifiedBy("BBPPK LEMBANG")
							 ->setTitle("Export data pegawai")
							 ->setSubject("aplikasi data kepegawaian BBPPK LEMBANG")
							 ->setDescription("Laporan data kepegawaian dari database.")
							 ->setKeywords("BBPPK LEMBANG jabar kepegawaian")
