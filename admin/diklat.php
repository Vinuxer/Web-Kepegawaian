            ...
            <div id="isi">
                ...
                <form id="formeditdiklat" action="diklat.php" method="post">
                    ...
                    <select name="jenis" id="jenis">
                        <option value="Bidang Pertanian" <?php echo ($dataDiklat&&$dataDiklat['jenis']!='Bidang Pertanian')?'':'selected="selected"'; ?>>Bidang Pertanian</option>
                        <option value="Bidang Industri" <?php echo ($dataDiklat&&$dataDiklat['jenis']!='Bidang Industri')?'':'selected="selected"'; ?>>Bidang Industri</option>
                        <option value="Bidang Jasa" <?php echo ($dataDiklat&&$dataDiklat['jenis']!='Bidang Jasa')?'':'selected="selected"'; ?>>Bidang Jasa</option>
                        <!-- <option value="Ketatausahaan" <?php //echo ($dataDiklat&&$dataDiklat['jenis']!='ketatausahaan')?'':'selected="selected"'; ?>>ketatausahaan</option>-->
    ...
    <div id="dialog-form" title="Tambah Diklat baru">
        ...
        <fieldset>
            ...
            <select name="tjenis" id="tjenis">
                ...
                <option value="Bidang Industri" >Bidang Industri</option>
